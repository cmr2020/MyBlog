jQuery(document).ready(function ($) {
    ...
    function LCommerce_google_maps() {
        if ($('.LCommerce-google-maps').length <= 0) {
            return;
        }
        $('.LCommerce-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    $(document).ready(function () {
        LCommerce_google_maps();
    });

    function LCommerce_init_menu_toggle() {
        var contain = '.LCommerce-nav-toggle';
    ...
    // ----------LCommerce_custom_scrollbar-------------------
    function LCommerce_custom_scrollbar() {
        $('.LCommerce-mini-cart .minicart-items').mCustomScrollbar();
        $('.LCommerce-mini-cart .minicart-items').change(function () {
            $('.LCommerce-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function LCommerce_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function LCommerce_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function LCommerce_remove_class_review() {
    ...
    // -----------LCommerce_details_thumd--------------------
    function LCommerce_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function LCommerce_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.LCommerce-dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.LCommerce-dropdown');
            var _allparent = $('.LCommerce-dropdown');

            if (_target.length > 0) {
                _allparent.not(_target).removeClass('open');
                if (
                    $(event.target).is('[data-LCommerce="LCommerce-dropdown"]') ||
                    $(event.target).closest('[data-LCommerce="LCommerce-dropdown"]').length > 0
                ) {
                    _target.toggleClass('open');
                    return false;
                }
            } else {
                $('.LCommerce-dropdown').removeClass('open');
            }
        });
    }

    function LCommerce_mobile_block() {
    ...
    // =====================slick============================
    function LCommerce_init_carousel() {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function LCommerce_tab_fade_effect() {
        // effect click
        $(document).on('click', '.LCommerce-tabs .tab-link a', function () {
    ...
    function quickview_popup() {
        ...
        if (window_size > 992) {
            $(document).on('click', '.quick-wiew-button', function () {
                $.magnificPopup.open({
                    items: {
                        src: '<div class="kt-popup-quickview "><div class="details-thumb"><div class="slider-product slider-for"><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div></div><div class="slider-product-button slider-nav nav-center"><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div><div class="details-item"><img src="assets/images/popup-quickview-item-1.jpg" alt="img"></div></div></div><div class="details-infor"><h1 class="product-title">نور آویز ایکلیپس</h1><div class="stars-rating"><div class="star-rating"><span class="star-5"></span></div><div class="count-star">(7)</div></div><div class="availability">وضعیت:<a href="#"> موجود در انبار</a></div><div class="price"><span>45000 تومان</span></div><div class="product-details-description"><ul><li>لورم ایپسوم متن ساختگی با تولید</li><li>وارداتی</li><li>شماره ثبت  25.658</li></ul></div><div class="variations"><div class="attribute attribute_color"><div class="color-text text-attribute">رنگبندی:<span>سفید/</span><span>سیاه/</span><span>ابی سیر/</span><span>قهوه ای</span></div><div class="list-color list-item"><a href="#" class="color1"></a><a href="#" class="color2"></a><a href="#" class="color3 active"></a><a href="#" class="color4"></a></div></div><div class="attribute attribute_size"><div class="size-text text-attribute">اندازه:</div><div class="list-size list-item"><a href="#" class="">بسیار کوچک</a><a href="#" class="">کوچک</a><a href="#" class="active">متوسط</a><a href="#" class="">بزرگ</a><a href="#" class="">بزرگ</a><a href="#" class="">بسیار بزرگتر</a></div></div></div><div class="group-button"><div class="yith-wcwl-add-to-wishlist"><div class="yith-wcwl-add-button"><a href="#">افزودن به علاقه مندی ها</a></div></div><div class="size-chart-wrapp"><div class="btn-size-chart"><a id="size_chart" href="assets/images/size-chart.jpg" class="fancybox"  target="_blank">مشاهده نمودار اندازه</a></div></div><div class="quantity-add-to-cart"><div class="quantity"><div class="control"><a class="btn-number qtyminus quantity-minus" href="#">-</a><input type="text" data-step="1" data-min="0" value="1" title="Qty" class="input-qty qty" size="4"><a href="#" class="btn-number qtyplus quantity-plus">+</a></div></div><button class="single_add_to_cart_button button">افزودن به سبد خرید</button></div></div></div></div>',
                        type: 'inline'
                    }
                });
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function LCommerce_countdown() {
        if ($('.LCommerce-countdown').length > 0) {
            ...
            $('.LCommerce-countdown').each(function () {
    ...
    $(window).resize(function () {
        ...
        LCommerce_masonry()
        kt_resizeMegamenu();
        LCommerce_remove_class_review();
        LCommerce_details_thumd_zoom();
        LCommerce_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
        quickview_popup();
        LCommerce_mobile_block();
        LCommerce_remove_class_review();
        LCommerce_custom_scrollbar()
    });
    LCommerce_masonry()
    LCommerce_dropdown();
    LCommerce_init_carousel();
    LCommerce_remove_class_review();
    LCommerce_tab_fade_effect();
    LCommerce_details_thumd_zoom();
    LCommerce_video();
    kt_resizeMegamenu();
    LCommerce_custom_scrollbar();
    LCommerce_countdown();
    LCommerce_init_menu_toggle();
    LCommerce_custom_scrollbar_header_nav();
}); 